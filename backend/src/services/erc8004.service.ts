 ...
 * Agents are registered on-chain with their metadata stored on IPFS.
 */
...
// Using multiple reliable RPC endpoints for better reliability
const CHAIN_CONFIG = {
  id: 11155111,
...
export class ERC8004Service {
  ...
  /**
   * Get agent metadata from the registry
   */
